...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    function operate() external {
        ...
        uniswapV2Pair_WBTC_USDT.swap(0, debt_USDT, address(this), "flashloan");
    ...
    function uniswapV2Call(
        ...
        uint debtToCover = amount1; // ยอด USDT ที่ยืมมา
        ...
        WBTC.transfer(address(uniswapV2Pair_WBTC_USDT), repay_WBTC); // โอนคืนตู้ 1
